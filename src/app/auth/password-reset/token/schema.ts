import { z } from "zod";
import { accountUpdateSchema } from "@/types/db/input";

export const newPasswordFormSchema = accountUpdateSchema
  .pick({ password: true })
  .extend({
    password: z
      .string()
...
export type NewPassword = z.infer<typeof newPasswordFormSchema>;
