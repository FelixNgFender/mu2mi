...
export default function TermsPage() {
  return (
    <section className="container relative flex h-full flex-1 flex-col gap-4 py-8">
      <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
        Terms and Conditions
      </h1>

      <p className="leading-7 not-first:mt-6">Welcome to Mu2Mi!</p>

      <p className="leading-7 not-first:mt-6">
        These terms and conditions outline the rules and regulations for the use
        of Mu2Mi&apos;s Website, located at https://mu2mi.com.
      </p>

      <p className="leading-7 not-first:mt-6">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Mu2Mi if you do not agree to take all
      ...
      <p className="leading-7 not-first:mt-6">
        We employ the use of cookies. By accessing Mu2Mi, you agreed to use
        cookies in agreement with the Mu2Mi&apos;s Privacy Policy.{" "}
      </p>
      ...
      <p className="leading-7 not-first:mt-6">
        Unless otherwise stated, Mu2Mi and/or its licensors own the intellectual
        property rights for all material on Mu2Mi. All intellectual property
        rights are reserved. You may access this from Mu2Mi for your own
        personal use subjected to restrictions set in these terms and
        conditions.
      </p>

      <p className="leading-7 not-first:mt-6">You must not:</p>
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>Republish material from Mu2Mi</li>
        <li>Sell, rent or sub-license material from Mu2Mi</li>
        <li>Reproduce, duplicate or copy material from Mu2Mi</li>
        <li>Redistribute content from Mu2Mi</li>
      </ul>
      ...
      <p className="leading-7 not-first:mt-6">
        ...
        exchange opinions and information in certain areas of the website. Mu2Mi
        ...
        of Mu2Mi,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Mu2Mi shall not be liable for the Comments
      ...
      <p className="leading-7 not-first:mt-6">
        Mu2Mi reserves the right to monitor all Comments and to remove any
      ...
      <p className="leading-7 not-first:mt-6">
        You hereby grant Mu2Mi a non-exclusive license to use, reproduce, edit
      ...
      <p className="leading-7 not-first:mt-6">
        ...
        the hyperlink compensates the absence of Mu2Mi; and (d) the link is in
      ...
      <p className="leading-7 not-first:mt-6">
        ...
        e-mail to Mu2Mi. Please include your name, your organization name,
      ...
      <p className="leading-7 not-first:mt-6">
        No use of Mu2Mi&apos;s logo or other artwork will be allowed for linking
