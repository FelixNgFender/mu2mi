...
export default function PrivacyPage() {
  return (
    <section className="container relative flex h-full flex-1 flex-col gap-4 py-8">
      ...
      <p className="leading-7 not-first:mt-6">Last updated: March 04, 2024</p>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <li>
          <p className="leading-7 not-first:mt-6">
            <strong>Application</strong> refers to Mu2Mi, the software program
        ...
        <li>
          <p className="leading-7 not-first:mt-6">
            ...
            this Agreement) refers to Mu2Mi.
          </p>
        </li>
        <li>
          <p className="leading-7 not-first:mt-6">
        ...
        <li>
          <p className="leading-7 not-first:mt-6">
            <strong>Website</strong> refers to Mu2Mi, accessible from{" "}
            <a
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          <p className="leading-7 not-first:mt-6">Email address</p>
        </li>
        <li>
          <p className="leading-7 not-first:mt-6">Usage Data</p>
        </li>
      </ul>
      <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">
        Usage Data
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          ...
          <p className="leading-7 not-first:mt-6">Type: Session Cookies</p>
          <p className="leading-7 not-first:mt-6">Administered by: Us</p>
          <p className="leading-7 not-first:mt-6">
        ...
        <li>
          ...
          <p className="leading-7 not-first:mt-6">Type: Persistent Cookies</p>
          <p className="leading-7 not-first:mt-6">Administered by: Us</p>
          <p className="leading-7 not-first:mt-6">
